...
#icon
image_icon=PhotoImage(file="C:/Users/krish/OneDrive/Documents/BMI calculator/icon.png")
root.iconphoto(False,image_icon)

#top
top=PhotoImage(file="C:/Users/krish/OneDrive/Documents/BMI calculator/top.png")
...
#two boxes
box=PhotoImage(file="C:/Users/krish/OneDrive/Documents/BMI calculator/box.png")
Label(root,image=box).place(x=20,y=100)
Label(root,image=box).place(x=240,y=100)

#scale
scale=PhotoImage(file="C:/Users/krish/OneDrive/Documents/BMI calculator/scale.png")
...
def slider_changed(event):
    ...
    img=(Image.open("C:/Users/krish/OneDrive/Documents/BMI calculator/man.png"))
...
Label(root, text="Height(cm)", font='arial 12', bg="#f0f1f5", fg="#000").place(x=30,y=120)
Label(root, text="Weight(kg)", font='arial 12', bg="#f0f1f5", fg="#000").place(x=250,y=120)
...
Label(root, text="cm", font='arial 10', bg="#f0f1f5", fg="#000").place(x=180,y=220)
Label(root, text="kg", font='arial 10', bg="#f0f1f5", fg="#000").place(x=400,y=220)
